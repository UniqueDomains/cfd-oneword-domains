...
> **Important:** this repository is a **public 9,417-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,424 domains** on the canonical page below.

**Public extract:** 9,417 rows · **Live catalog:** 9,424 domains
...
| ----------------------- | ------------------------------------------------ |
| 9,417-row public sample | 9,424 live domains                               |
