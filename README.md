# Available .CFD One-Word Domains (9,451)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C424%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C451%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,424-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,451 domains** on the canonical page below.

**Public extract:** 9,424 rows · **Live catalog:** 9,451 domains
...
- `cfd.csv` — public CSV extract (9,424 rows)
- `cfd.json` — public JSON extract (9,424 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,424-row public sample | 9,451 live domains                               |
