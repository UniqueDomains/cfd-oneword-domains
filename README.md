# Available .CFD One-Word Domains (9,417)
...
Daily-updated dataset of available and resale .cfd one-word domains from Unique Domains.
...
- `cfd.csv` — public CSV extract (9,417 rows)
- `cfd.json` — public JSON extract (9,417 rows)
...
| component.cfd    | available | $21.98    | —             | 84             | 20     | 9      | namecheap                          |
...
| the.cfd          | resell    | —         | —             | 98             | 58     | 3      | Dynadot LLC                        |
...
> Unique Domains. *Available .CFD One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
